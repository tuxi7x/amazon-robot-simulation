...
#include <memory>
#include "../../../Client/library/dialogs/ErrorDialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ErrorDialog_t, stringdata0) + ofs), len 
...
const QMetaObject ErrorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ErrorDialog.offsetsAndSize,
